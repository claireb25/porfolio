 ...
 */
final class Version20180613095639 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE presentation CHANGE phone_number phone_number VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE presentation CHANGE phone_number phone_number INT NOT NULL');
