 ...
 */
final class Version20180718133937 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE projects ADD github_link VARCHAR(255) DEFAULT NULL, CHANGE project_year_id project_year_id INT DEFAULT NULL, CHANGE place_id place_id INT DEFAULT NULL, CHANGE main_img_id main_img_id INT DEFAULT NULL, CHANGE sec_img_id sec_img_id INT DEFAULT NULL, CHANGE link_to_project link_to_project VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE experiences CHANGE exp_title exp_title TINYTEXT NOT NULL');
        $this->addSql('ALTER TABLE images CHANGE picture picture VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE presentation DROP cv_link');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE presentation ADD cv_link VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE projects DROP github_link, CHANGE project_year_id project_year_id INT DEFAULT NULL, CHANGE place_id place_id INT DEFAULT NULL, CHANGE main_img_id main_img_id INT DEFAULT NULL, CHANGE sec_img_id sec_img_id INT DEFAULT NULL, CHANGE link_to_project link_to_project VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
